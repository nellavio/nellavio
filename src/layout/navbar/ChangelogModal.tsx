...
export const ChangelogModal = ({ closeModal }: ChangelogModalProps) => {
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => !open && closeModal()}>
      <DialogContent className="max-w-[90vw] sm:max-w-[42rem] pt-12 sm:pt-12">
        <DialogTitle className="sr-only">Changelog</DialogTitle>
        <div className="w-full min-w-0 md:min-w-[32rem] h-full max-h-[65vh] overflow-y-auto pr-4 -mt-4">
