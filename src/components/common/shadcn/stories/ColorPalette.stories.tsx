...
const colorGroups = {
  ...
  icons: [
    ...
    { name: "Kpi Icon Blue", cssVar: "kpiIconBlue" },
    { name: "Kpi Icon Green", cssVar: "kpiIconGreen" },
    { name: "Kpi Icon Purple", cssVar: "kpiIconPurple" },
    { name: "Kpi Icon Amber", cssVar: "kpiIconAmber" },
    { name: "Customer Tier Vip", cssVar: "customerTierVip" },
    { name: "Customer Tier Pro", cssVar: "customerTierPro" },
    { name: "Customer Tier New", cssVar: "customerTierNew" },
  ],
  backgrounds: [
    ...
    { name: "Chart Tertiary Fill", cssVar: "chartTertiaryFill" },
    { name: "Chart Quaternary Fill", cssVar: "chartQuaternaryFill" },
    { name: "Chart Quinary Fill", cssVar: "chartQuinaryFill" },
    { name: "Sales Note Bg", cssVar: "salesNoteBg" },
    ...
    { name: "Date Range Button Bg", cssVar: "dateRangeButtonBg" },
  ],
  borders: [
