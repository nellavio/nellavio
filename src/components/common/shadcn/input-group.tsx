...
const inputGroupInputVariants = cva(
  "flex w-full rounded-md border text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-secondaryText focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 transition px-3",
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        "flex min-h-[80px] w-full rounded-md border border-inputBorder bg-inputBg px-3 py-2 text-sm ring-offset-background placeholder:text-secondaryText focus-visible:outline-none focus-visible:border-ringBorder disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      ref={ref}
      data-slot="input-group-control"
