...
export const CenteredPageWrapper = ({ children }: CenteredPageWrapperProps) => {
  return (
    <main
      className="flex pb-0 flex-col h-dvh w-full pt-0 md:pt-8 lg:pt-[3rem] xl:pt-[6rem] 1xl:pt-[6.5rem] 3xl:pt-28 xl:pb-8 items-center px-0 md:px-0 1xl:px-0 2xl:px-0 bg-secondaryBg"
      role="main"
    >
